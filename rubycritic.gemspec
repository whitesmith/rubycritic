...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency 'cucumber', '~> 9.0.2', '!= 9.0.0'
  spec.add_development_dependency 'diff-lcs', '~> 1.3'
  spec.add_development_dependency 'fakefs', '~> 2.5.0'
  spec.add_development_dependency 'mdl', '~> 0.13.0', '>= 0.12.0'
  spec.add_development_dependency 'minitest', '~> 5.20.0', '>= 5.3.0'
  ...
  spec.add_development_dependency 'rubocop', '~> 1.57.1', '>= 1.54.0'
